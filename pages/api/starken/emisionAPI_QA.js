    ...
    try {
      const response = await fetch(
        process.env.URL_EMISION_QA,
        {
          ...
          body: JSON.stringify({
            rutEmpresaEmisora: process.env.RUT_EMPRESA_EMISORA_QA,
            rutUsuarioEmisor: process.env.RUT_USUARIO_EMISOR_QA,
            claveUsuarioEmisor: process.env.CLAVE_USUARIO_EMISOR_QA,
            rutDestinatario: "",
            dvRutDestinatario: "",
            ...
            tipoEntrega: "2",
            tipoPago: "2",
            numeroCtaCte: process.env.NUMERO_CTA_CTE_QA,
            dvNumeroCtaCte: process.env.DV_NUMERO_CTA_CTE_QA,
            centroCostoCtaCte: "0",
            valorDeclarado: "1000",
