...
const VTEX_ACCOUNT = 'ventusperu'
const API_VTEX_KEY = process.env.API_VTEX_KEY_PE || ''
const API_VTEX_TOKEN = process.env.API_VTEX_TOKEN_PE || ''

if (!API_VTEX_KEY || !API_VTEX_TOKEN) {
  throw new Error('Las credenciales de VTEX no están configuradas (API_VTEX_KEY_PE / API_VTEX_TOKEN_PE)')
}
