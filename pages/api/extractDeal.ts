...
export default async (req: NextApiRequest, res: NextApiResponse<Response>) => {
  ...
  try {
    ...
    const response = await axios({
      ...
      url: url,
      data: {
        "properties": [ "dealname","rut_pagador","orden_de_compra","hubspot_owner_id","dealstage","hs_object_id", "amount","numero_envio","region_envio", "comuna_envio", "codigo_postal_de_envio","ciudad_envio","casa_o_depto_de_envio","calle_envio",
