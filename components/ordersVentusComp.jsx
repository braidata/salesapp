...
const SelectComponent = () => {
  ...
  keys = [
    {
      key: "status",
      placeholder: "Ejemplo: on-hold"
    },
    {
      key: "billing.first_name",
      placeholder: "Ejemplo: LOCALES Y COMERCIO"
    },
    {
      key: "billing.last_name",
      placeholder: "Ejemplo: BLF DOS SPA"
    },
    {
      key: "billing.address_1",
      placeholder: "Ejemplo: matias cousio"
    },
    {
      key: "billing.city",
      placeholder: "Ejemplo: METROPOLITANA"
    },
    {
      key: "billing.state",
      placeholder: "Ejemplo: 43"
    },
    {
      key: "billing.country",
    ...
    {
      key: "billing.email",
      placeholder: "Ejemplo: contacto@binomiosbar.cl"
    },
    {
      key: "billing.phone",
      placeholder: "Ejemplo: +56 9 9545 4720"
    },
    {
    ...
    {
      key: "meta_data._billing_giro",
      placeholder: "Ejemplo: cafeteria"
    },
    {
      key: "meta_data._billing_razon_social",
      placeholder: "Ejemplo: LOCALES Y COMERCIO BLF DOS SPA"
    },
    {
      key: "meta_data._shipping_comuna",
      placeholder: "Ejemplo: SANTIAGO CENTRO"
    },
    // {
    //   key: "meta_data._shipping_Numero_Direccion",
    //   placeholder: "Ejemplo: 119"
    // },
    {
      key: "meta_data._retiro_local_rut",
      placeholder: "Ejemplo: 13069905-7"
    },
    {
      key: "meta_data._retiro_local_name",
      placeholder: "Ejemplo: Rodrigo Gonzalez"
    },
    {
  ...
  const handleSubmit = async (e) => {
    ...
    // Crear un objeto meta_data completo si la clave comienza con "_"
    let updatedData = {};
    if (metaDataKey.startsWith("_")) {
      ...
      // Dividir la clave en partes (si hay un punto en la clave)
      const keyParts = metaDataKey.split(".");
      // Actualizar el objeto updatedData de manera recursiva según las partes de la clave
    ...
    // Actualizar el objeto updatedData con la clave y el valor
