...
export default function DealCard({ name, id, stage, amount, sendFunction, editFunction, refE}) {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center w-full h-full">
            ...
            <button onClick={sendFunction} className="bg-blue-500 hover:bg-blue-700 text-gray-800 font-bold py-4 px-4 rounded-sm w-1 h-16 dark:text-gray-800">
