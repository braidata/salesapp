...
const OrderTable = ({ data, functionS }) => {
  ...
  ">{status}</p>
                        ...
                        <p className="py-2 px-2 mt-2 mb-2 sm:w-24 text-center rounded-md border dark:border-cyan-300/80 dark:hover:border-cyan-200/80 border border-cyan-600 rounded shadow hover:bg-cyan-200/20 hover:text-cyan-700 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out dark:hover:bg-cyan-700/20 dark:hover:text-cyan-300 dark:focus:shadow-outline dark:focus:outline-none dark:transition duration-150 ease-in-out dark:ease-in-out dark:duration-150 dark:shadow-outline dark:focus:outline-none dark:focus:shadow-outline dark:transition duration-150 ease-in-out
  ">{status}</p>
                      ): status === "Procesado" ? (
                        <p className="py-2 px-2 mt-2 mb-2 sm:w-24 text-center rounded-md border dark:border-teal-300/80 dark:hover:border-teal-200/80 border border-teal-600 rounded shadow hover:bg-teal-200/20 hover:text-teal-700 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out dark:hover:bg-teal-700/20 dark:hover:text-teal-300 dark:focus:shadow-outline dark:focus:outline-none dark:transition duration-150 ease-in-out dark:ease-in-out dark:duration-150 dark:shadow-outline dark:focus:outline-none dark:focus:shadow-outline dark:transition duration-150 ease-in-out
  ">{status}</p>
                      ):status === "Facturar"||status === "Prefacturar"||status === "Facturado" ? (
                        <p className="py-2 px-2 mt-2 mb-2 sm:w-24 text-center rounded-md border dark:border-orange-300/80 dark:hover:border-orange-200/80 border border-orange-600 rounded shadow hover:bg-orange-200/20 hover:text-orange-700 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out dark:hover:bg-orange-700/20 dark:hover:text-orange-300 dark:focus:shadow-outline dark:focus:outline-none dark:transition duration-150 ease-in-out dark:ease-in-out dark:duration-150 dark:shadow-outline dark:focus:outline-none dark:focus:shadow-outline dark:transition duration-150 ease-in-out
  ">{status}</p>
                      ) : status === "Error SAP" ? (
