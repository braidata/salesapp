...
export default function PaymentForm() {
 ...
 //use mysqlPaymentsImages for save the images and the url on the database
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="bg-gray-800 bg-opacity-75 rounded-lg px-8 pt-6 pb-8 mb-4">
      ...
      <div className="mb-4">
        ...
        <div className="mb-4">
        <label className="block text-gray-300 font-bold mb-2 dark:text-gray-300" htmlFor="rut_cliente">
            Rut Cliente:
        </label>
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-gray-300 dark:bg-gray-800 text-gray-900 dark:text-gray-200" type="text" name="rut_cliente" value={paymentData.rut_cliente} onChange={handleChange} required />
        </div>
        <div className="mb-4">
        <label className="block text-gray-300 font-bold mb-2 dark:text-gray-300" htmlFor="banco_destino">
            Banco Destino:
        </label>
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-gray-300 dark:bg-gray-800 text-gray-900 dark:text-gray-200" type="text" name="banco_destino" value={paymentData.banco_destino} onChange={handleChange} required />
        </div>
        {/* image uploader */}
        <div className="mb-4">
